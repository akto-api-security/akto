...
public final class FilterAction {
    ...
    public DataOperandsFilterResponse applyFilterOnPayload(FilterActionRequest filterActionRequest, String payload) {
        ...
        if (filterActionRequest.getConcernedProperty() != null && filterActionRequest.getConcernedProperty().equalsIgnoreCase(CollectionOperands.FOR_ALL.toString())) {
        ...
        if (filterActionRequest.getConcernedSubProperty() != null && filterActionRequest.getConcernedSubProperty().toLowerCase().equals("key")) {
            ...
            getMatchingKeysForPayload(payloadObj, null, filterActionRequest.getQuerySet(), filterActionRequest.getOperand(), matchingKeySet, doAllSatisfy);
    ...
    public void getMatchingKeysForPayload(Object obj, String parentKey, Object querySet, String operand, Set<String> matchingKeys, boolean doAllSatisfy) {
        Boolean res = false;
        if (obj instanceof BasicDBObject) {
            ...
            for(String key: keySet) {
                ...
                getMatchingKeysForPayload(value, key, querySet, operand, matchingKeys, doAllSatisfy);
                
            }
        } else if (obj instanceof BasicDBList) {
            for(Object elem: (BasicDBList) obj) {
                getMatchingKeysForPayload(elem, parentKey, querySet, operand, matchingKeys, doAllSatisfy);
            }
        } else {

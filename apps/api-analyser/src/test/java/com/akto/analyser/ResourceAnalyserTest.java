...
public class ResourceAnalyserTest extends MongoBasedTest {
    ...
    public void testEndToEnd() {
        ...
        APICatalogSync.mergeUrlsAndSave(0, true, false, httpCallParser.apiCatalogSync.existingAPIsInDb);
        APICatalogSync.mergeUrlsAndSave(1, true, false, httpCallParser.apiCatalogSync.existingAPIsInDb);

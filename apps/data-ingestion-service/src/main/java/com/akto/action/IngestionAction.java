        ...
        try {
            if (batchData == null) {
                loggerMaker.errorAndAddToDb(
                        "ingestData: batchData is null; POST JSON must be {\"batchData\":[ { IngestDataBatch fields... }, ... ]}",
            ...
            loggerMaker.errorAndAddToDb("Error while inserting data to Kafka: " + detail, LoggerMaker.LogDb.DATA_INGESTION);
            return Action.ERROR.toUpperCase();
        }

#!/usr/bin/env bash
# akto_common.sh - shared helpers for Akto cursor hooks (bash port).
#
...
# ---------------------------------------------------------------------------
AKTO_LOG_DIR="${LOG_DIR:-$HOME/.cursor/akto/chat-logs}"
...
AKTO_CONNECTOR="${AKTO_CONNECTOR:-cursor}"
AKTO_CONNECTOR_VALUE="${AKTO_CONNECTOR_VALUE:-cursor}"

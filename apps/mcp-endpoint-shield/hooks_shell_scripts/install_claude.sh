...
# ========================================================================================
# MCP Endpoint Shield - Claude CLI Hook Installer (Global / multi-user variant)
# ========================================================================================
# Automatically installs Akto guardrails hooks for Claude CLI if detected
# Runs against a resolved TARGET_USER_HOME (argument or /Users/* scan) and fixes ownership
# ========================================================================================
...
# Export AKTO_DATA_INGESTION_URL if set via argument
...
if [ -n "$TARGET_USER_HOME" ]; then
    ...
    # Multi-user mode: install for all valid users
    EXIT_CODE=0
    for u in /Users/*/; do
        u="${u%/}"
        base="$(basename "$u")"

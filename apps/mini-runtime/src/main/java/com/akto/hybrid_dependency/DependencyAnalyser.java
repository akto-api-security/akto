...
public class DependencyAnalyser {
    ...
    public void analyse(String message, int finalApiCollectionId) {
        ...
        boolean runDependencyAnalyser = apiCollection == null || apiCollection.isRunDependencyAnalyser() || DataActor.actualAccountId == 1745303931 || DataActor.actualAccountId == 1741069294;

...
public class DependencyAnalyser {
    ...
    public DependencyAnalyserHelper dependencyAnalyserHelper;
    public Map<Integer, APICatalog> dbState;

    public DependencyAnalyser(Map<Integer, APICatalog> dbState) {
        this.dbState = dbState;
        dependencyAnalyserHelper = new DependencyAnalyserHelper(dbState);
    }
    ...
    public void syncWithDb() {
        ...
        for (DependencyNode dependencyNode: dependencyAnalyserHelper.getNodes().values()) {
        ...
        dependencyAnalyserHelper.setNode(new HashMap<>());
    }

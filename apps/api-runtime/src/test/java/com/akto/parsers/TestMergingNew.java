...
//        assertEquals(2, keyTypes.getOccurrences().size());
    ...
    public void testNonJsonResponsePayloadPayload() throws Exception {
        ...
        List<HttpResponseParams> responseParams = new ArrayList<>();
        for (int i = 0; i < 30; i++) {
            HttpResponseParams httpResponseParams = HttpCallParserHelper.parseKafkaMessage(a);
...
//        assertEquals(1, dbUpdateReturn3.bulkUpdatesForSingleTypeInfo.size()); // even though minMax didn't change new values were added
    ...
    public void testSampleDataUpdate() throws Exception {
        ...
        HttpResponseParams httpResponseParams1 = HttpCallParserHelper.parseKafkaMessage(payload1);
        ...
        HttpResponseParams httpResponseParams2 = HttpCallParserHelper.parseKafkaMessage(payload1UpdatedRequestPayload);
        ...
        HttpResponseParams httpResponseParams3 = HttpCallParserHelper.parseKafkaMessage(payload2);
        ...
        HttpResponseParams httpResponseParams4 = HttpCallParserHelper.parseKafkaMessage(payload3);
        ...
        HttpResponseParams httpResponseParams5 = HttpCallParserHelper.parseKafkaMessage(payload4);

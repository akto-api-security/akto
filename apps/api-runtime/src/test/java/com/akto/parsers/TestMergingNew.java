...
public class TestMergingNew extends MongoBasedTest {
    ...
    public void testMultipleIntegerMerging() {
        ...
        parser.apiCatalogSync.syncWithDB(false, true, SyncLimit.noLimit, SyncLimit.noLimit, SyncLimit.noLimit, SyncLimit.noLimit, Source.HAR);
...
//    @Test
    public void testUrlParamSingleTypeInfoAndValues() {
        ...
        parserNew.apiCatalogSync.syncWithDB(false, true, SyncLimit.noLimit, SyncLimit.noLimit, SyncLimit.noLimit, SyncLimit.noLimit, Source.HAR);
        APICatalogSync.mergeUrlsAndSave(123,true, false, parser.apiCatalogSync.existingAPIsInDb, false, false, false);
...
//        assertEquals(1, dbUpdateReturn3.bulkUpdatesForSingleTypeInfo.size()); // even though minMax didn't change new values were added
    ...
    public void testSpecialCharHostMerging() {
        ...
        try {
            ...
            httpCallParser.apiCatalogSync.syncWithDB(false, true, SyncLimit.noLimit, SyncLimit.noLimit,
                SyncLimit.noLimit, SyncLimit.noLimit, Source.HAR);
    ...
    public void testMultipleLongMerging() {
        ...
        parser.apiCatalogSync.syncWithDB(true, true, SyncLimit.noLimit, SyncLimit.noLimit, SyncLimit.noLimit, SyncLimit.noLimit, Source.HAR);

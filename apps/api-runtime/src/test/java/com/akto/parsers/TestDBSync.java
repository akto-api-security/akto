...
public class TestDBSync extends MongoBasedTest {
    ...
    public void testParameterizedURL() {
        ...
        sync.syncWithDB(false, true, SyncLimit.noLimit, SyncLimit.noLimit, SyncLimit.noLimit, SyncLimit.noLimit, Source.HAR);
...
//    @Test
    ...
    public void testHostNameForSourceOther() throws Exception {
        ...
        httpCallParser.apiCatalogSync.syncWithDB(true, true, SyncLimit.noLimit, SyncLimit.noLimit, SyncLimit.noLimit, SyncLimit.noLimit,
            Source.HAR);

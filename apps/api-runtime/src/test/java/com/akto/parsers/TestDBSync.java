...
//    @Test
    ...
    public void testApiCollectionRegexMapper() throws Exception {
        ...
        HttpResponseParams httpResponseParams1 = HttpCallParserHelper.parseKafkaMessage(message1);
        HttpResponseParams httpResponseParams2 = HttpCallParserHelper.parseKafkaMessage(message2);
        HttpResponseParams httpResponseParams3 = HttpCallParserHelper.parseKafkaMessage(message3);
        HttpResponseParams httpResponseParams4 = HttpCallParserHelper.parseKafkaMessage(message4);
        HttpResponseParams httpResponseParams5 = HttpCallParserHelper.parseKafkaMessage(message5);

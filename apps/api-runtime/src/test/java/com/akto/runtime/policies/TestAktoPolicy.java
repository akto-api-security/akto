...
public class TestAktoPolicy extends MongoBasedTest {
    ...
    public HttpResponseParams generateHttpResponseParams(String url, URLMethods.Method method, int aci,
                                                         List<String> authTypes, boolean isPublic) {
        ...
        for (String authType: authTypes) {
            switch (authType) {
                ...
                case ApiInfo.AuthType.JWT:
                    ...
                    break;
                case ApiInfo.AuthType.API_TOKEN:
                    break;
                case ApiInfo.AuthType.BEARER:

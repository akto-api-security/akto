...
public class WindowBasedThresholdNotifierTest {
    ...
    @Test
    public void testQualifyForNotification() {
        ...
        HttpResponseParams responseParam =
                WindowBasedThresholdNotifierTest.generateResponseParamsForStatusCode(400);

        assertTrue(notifier.qualifyForNotification(responseParam));
    }
    ...
    public void testShouldNotify() throws InterruptedException {
        ...
        assertEquals(1, data.getRequests().size());
        assertEquals(data.getLastNotifiedAt(), lastNotifiedAt);
        ;
    }
}

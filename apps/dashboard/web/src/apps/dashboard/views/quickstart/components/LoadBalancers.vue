    ...
    data() {
        return {
            ...
            quick_start_policy_lines: [
                ...
                `            ], `,
                `            "Resource": [`,
                `                "arn:aws:lambda:AWS_REGION:AWS_ACCOUNT_ID:function:MIRRORING_STACK_NAME*"`,
                `            ]`,
                `        }, `,
                `        {`,
                `            "Sid": "14", `,
                ...
                `            ], `,
                `            "Resource": [`,
                `                "arn:aws:iam::AWS_ACCOUNT_ID:role/service-role/MIRRORING_STACK_NAME-*", `,
                `                "arn:aws:iam::AWS_ACCOUNT_ID:role/MIRRORING_STACK_NAME-*"`,
                `            ]`,
                `        }, `,
                `        {`,
                `            "Sid": "16", `,

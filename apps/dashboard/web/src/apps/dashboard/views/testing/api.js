...
export default {
    ...
    scheduleTestForCustomEndpoints(apiInfoKeyList, startTimestamp, recurringDaily, selectedTests, testName, testRunTime, maxConcurrentRequests, isCallFromAktoGPT) {
        let source = isCallFromAktoGPT ? "AKTO_GPT": "TESTING_UI";
        return request({
            url: '/api/startTest',
            method: 'post',

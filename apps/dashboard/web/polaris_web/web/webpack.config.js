...
module.exports = {
  ...
  output: {
    ...
    publicPath: process.env.VERSION ==='' || process.env.VERSION.includes("akto-release-version") ? '/polaris_web/web/dist/':  'https://d1hvi6xs55woen.cloudfront.net/on_prem/polaris_web/' + process.env.VERSION +  '/dist/',
    filename: '[name].js'
  },
  module: {
    rules: [

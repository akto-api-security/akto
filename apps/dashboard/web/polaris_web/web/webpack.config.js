...
module.exports = {
  ...
  output: {
    ...
    publicPath: process.env.VERSION ==='' || process.env.VERSION.includes("akto-release-version") ? '/polaris_web/web/dist/':  'https://d3as5gx79fwfqr.cloudfront.net/polaris_web/' + process.env.VERSION +  '/dist/',
    filename: '[name].js'
  },
  module: {
    rules: [

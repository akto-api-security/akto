export const labelMap = {
  ...
  "Gen AI": {
    ...
    "API Endpoints Discovered": "AI Agent Components Discovered",
  ...
  "Agentic Security": {
    ...
    "API Endpoints Discovered": "Agentic Components Discovered",
  ...
  "Endpoint Security": {
    "API Security Posture": "Endpoint Security Posture",
    "API Discovery": "Endpoint Discovery",
    "API collections": "Endpoint Collections",
    "API Collections": "Endpoint Collections",
    "API Collection Coverage": "Endpoint Collection Coverage",
    "API collection name": "Endpoint Collection Name",
    "API Testing": "Endpoint Security Testing",
    "Threat Detection": "Endpoint Guardrails",
    "Threat": "Endpoint Guardrail",
    "Threat Policy": "Endpoint Guardrail Policy",
    "Total APIs": "Total Endpoints",
    "Critical APIs": "Critical Endpoints",
    "Tested APIs (Coverage)": "Tested Endpoints (Coverage)",
    "Sensitive in response APIs": "Sensitive in Response Endpoints",
    "Untracked APIs": "Untracked Endpoints",
    "Total endpoints": "Total endpoints",
    "Test your APIs": "Test your Endpoints",
    "API Security": "Endpoint Security",
    "API endpoint": "Endpoint",
    "API endpoints": "Endpoints",
    "API details": "Endpoint details",
    "New endpoints": "New endpoints",
    "New sensitive endpoints": "New sensitive endpoints",
    "APIs Affected": "Endpoints Affected",
    "APIs": "Endpoints",
    "API": "Endpoint",
    "API response": "Endpoint response",
    "API request": "Endpoint request",
    "API Risk Score": "Endpoint Risk Score",
    "Endpoint": "Endpoint",
    "API changes": "Endpoint changes",
    "APIs Tested": "Endpoints Tested",
    "APIs with most open issues": "Endpoints with most open issues",
    "Api": "Endpoint",
    "Apis": "Endpoints",
    "API parameter": "Endpoint parameter",
    "API parameters": "Endpoint parameters",
    "endpoint": "endpoint",
    "endpoints": "endpoints",
    "URLs": "URLs",
    "security testing": "security testing",
    ...
    "Test": "Test",
    "test coverage": "test coverage",
    "API security tests": "Endpoint security tests",
    "Run test": "Run test",
    "run test": "run test",
    "Run Test": "Run Test",
    "Run tests": "Run Tests",
    ...
    "Testing": "Testing",
    "Tested": "Tested",
    "API Security testing": "Endpoint Security testing",
    "tests selected": "tests selected",
    "testing": "testing",
    "Test library":"Test library",
    "Endpoint Shield": "Endpoint Shield",

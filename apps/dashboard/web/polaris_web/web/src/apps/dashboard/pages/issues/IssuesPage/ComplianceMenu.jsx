...
export const getCompliances = () => {
    if (isMCPSecurityCategory() || isAgenticSecurityCategory() || isGenAISecurityCategory() || isEndpointSecurityCategory()) {
        return ["OWASP Agentic Skills Top 10", "OWASP Agentic Top 10", "OWASP LLM", "EU AI Act", "NIST AI Risk Management Framework", "CIS Controls", "CSA CCM", "Cybersecurity Maturity Model Certification (CMMC)", "FISMA", "FedRAMP", "GDPR", "HIPAA", "ISO 27001", "NIST 800-171", "NIST 800-53", "PCI DSS", "SOC 2", "OWASP", "MITRE ATLAS"];
    }

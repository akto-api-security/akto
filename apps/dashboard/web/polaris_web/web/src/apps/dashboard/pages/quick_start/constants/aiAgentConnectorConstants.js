...
export const DOCS_URL_COPILOT_STUDIO_MULTI_ENV = 'https://ai-security-docs.akto.io/akto-atlas-agentic-ai-security-for-employee-endpoints/endpoints-discovery-agents/microsoft-copilot-studio-multi-environment';
...
export const DESCRIPTION_COPILOT_STUDIO_MULTI_ENV = 'Connect your Power Platform tenant once and Akto automatically discovers every environment, provisions an application user in each, and imports Copilot Studio conversation data from all of them.';

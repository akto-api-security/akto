...
function SingleTestRunPage() {
  ...
  const components = [
    runningTestsComp, <TrendChart key={tempLoading.running} hexId={hexId} setSummary={setSummary} show={selectedTestRun.run_type && selectedTestRun.run_type !== 'One-time'} vulCount={tableCountObj.vulnerable} />,

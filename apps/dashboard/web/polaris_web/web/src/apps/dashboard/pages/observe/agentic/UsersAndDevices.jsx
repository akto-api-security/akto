...
function UsersAndDevices() {
    ...
    const loadStats = useCallback(async () => {
        try {
            ...
            // Identity maps are no longer sent — AgenticObserveAction resolves them server-side now.
    ...
    const saveEditTag = useCallback(async () => {
        ...
        try {
            ...
            // Backend invalidates its tags cache on this write, so the refetch below sees the edit.

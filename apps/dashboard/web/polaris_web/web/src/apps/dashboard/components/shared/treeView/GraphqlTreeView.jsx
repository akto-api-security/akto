...
const PRE_STYLE = { margin: 0, fontFamily: 'monospace', fontSize: '13px', lineHeight: '1.6', color: '#637381' }
            ...
            <Card padding="10">
                <Box width="500px">
                    <VerticalStack gap={4}>
                        ...
                        <Text color="subdued" variant="bodyMd">Results in:</Text>
                        <Box background="bg-subdued" padding="3" borderRadius="2">
                            <pre style={PRE_STYLE}>{treeExample}</pre>
                        </Box>
                        <Box paddingBlockStart={2}>
                            <Button primary onClick={() => setGroupByOperation(prev => !prev)}>

...
export default function LeftNav() {
    ...
    const guardrailViolationsNewLayout = LocalStore((state) => state.guardrailViolationsNewLayout);
        ...
        let items = [
            ...
            ...(window?.STIGG_FEATURE_WISE_ALLOWED?.THREAT_DETECTION?.isGranted && dashboardCategory !== CATEGORY_DAST  ? [{
                    ...
                    subNavigationItems: [
                        ...
                        ...((window?.STIGG_FEATURE_WISE_ALLOWED?.GUARDRAIL_VIOLATIONS_NEW_UI?.isGranted &&
                            dashboardCategory === CATEGORY_ENDPOINT_SECURITY &&
                            guardrailViolationsNewLayout) ? [{
                            label: "Violations",
                            onClick: () => {

            ...
            <IssuesGraphsGroup heading="Issues summary">
                {[
                    <HorizontalGrid gap={5} columns={2} key="critical-issues-graph-detail">
                        <CriticalUnresolvedApisByAge apiCollectionIds={pageScopeApiCollectionIds} />
                        <CriticalFindingsGraph startTimestamp={startTimestamp} endTimestamp={endTimestamp} linkText={""} linkUrl={""} filterCollectionsId={pageScopeApiCollectionIds} />
                    </HorizontalGrid>,

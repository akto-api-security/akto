...
import { ArrowUpMinor, AttachmentMajor } from '@shopify/polaris-icons'
...
import InviteUserModal from '../settings/users/InviteUserModal'
...
function AskAktoConversation() {
    ...
    // Props for InviteUserModal (reusing for share functionality)
    const roleHierarchy = []
    const rolesOptions = [
        {
            items: [
...
• Assign ownership and review permissions for shadow agents`
    ...
    return (
        <div className="ask-akto-conversation">
            ...
            {/* Share Modal - reusing InviteUserModal */}
            <InviteUserModal 

...
function ActiveTestingSteps({currentStep, totalSteps, stepsTextArr}) {
                    ...
                    return(
                        <Box width={index === totalSteps - 1 ? "24px" :"252px"} key={"index " + index}>
                            <HorizontalStack wrap={false} key={index}>
                                ...
                                {index < totalSteps - 1 ? <Box width="100%" minHeight='3px' background={currentStep > index ? 'bg-primary' : 'bg-subdued-active'}></Box> : null}
                            </HorizontalStack>
                        </Box>
                    )}
                )}
...
export default ActiveTestingSteps
...
function TestSuite() {
    ...
    const fetchData = async () => {
        ...
        const subCategoryMap = localSubCategoryMap;
        ...
        Object.entries(listData).forEach(([key, value]) => {
            ...
            const keyObj = {
                name: key,
                subCategoryList: testSuiteSubCategoryMap,
                id: id++
            }

            const autoGeneratedTestSuite = transform.getPrettifiedObj(keyObj, value, true);

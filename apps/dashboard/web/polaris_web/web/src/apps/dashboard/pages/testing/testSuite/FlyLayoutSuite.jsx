    ...
    const handleTestSuiteSave = async () => {
        ...
        try {
            if (selectedTestSuite && hasChanged && !selectedTestSuite.isAutoGenerated) {
                ...
                // if user have not changed the name of the auto generated test suite then generate new name
                let name = (selectedTestSuite?.isAutoGenerated && testSuiteName === selectedTestSuite?.testSuiteName)? `${testSuiteName} Custom ${Date.now()}` : testSuiteName;
    ...
    const headingComponents = (
        <Box borderColor="border-subdued" borderBlockStartWidth="1" borderBlockEndWidth="1" background="bg-subdued" padding={4}>
            <HorizontalStack align="space-between" wrap={false}>
                ...
                <Box width="58%" paddingBlockStart={5}>

...
export const AGENTIC_TREE_DATA = [
    // ── AI Agents ─────────────────────────────────────────────────────────────────
    { path: ["cursor-ai"],                      name: "Cursor AI",             type: "AI Agent",   assetTagValue: "cursor",     riskScore: 4.2, violations: { critical:1, high:2, medium:0, low:3 }, endpointCount: 4,   aiInteractions: 1200000, groups: [{ name: "Engineering", count: 4 }],                                                                          deviceCount: 4, lastSeen: "2m ago" },
    ...
    { path: ["vscode"],                         name: "VS Code",               type: "AI Agent",   assetTagValue: "vscode",     riskScore: 3.6, violations: { critical:0, high:1, medium:1, low:0 }, endpointCount: 1,   aiInteractions: 340000,  groups: [{ name: "Engineering", count: 1 }],                                                                          deviceCount: 1, lastSeen: "45m ago", skillCount: 12 },
    ...
    { path: ["claude-desktop"],                 name: "Claude Desktop",        type: "AI Agent",   assetTagValue: "claude1",    riskScore: 3.2, violations: { critical:0, high:1, medium:0, low:1 }, endpointCount: 3,   aiInteractions: 680000,  groups: [{ name: "Engineering", count: 1 }, { name: "Finance", count: 1 }, { name: "HR", count: 1 }],               deviceCount: 3, lastSeen: "1h ago",  skillCount: 23 },
    ...
    { path: ["playwright-ai"],                  name: "Playwright AI",         type: "AI Agent",   assetTagValue: "playwright", riskScore: 4.3, violations: { critical:1, high:2, medium:1, low:0 }, endpointCount: 1,   aiInteractions: 120000,  groups: [{ name: "QA", count: 1 }],                                                                                   deviceCount: 1, lastSeen: "6h ago",  skillCount: 5 },

    { path: ["jupyter-ai"],                     name: "Jupyter AI",            type: "AI Agent",   assetTagValue: "jupyter",    riskScore: 2.0, violations: { critical:0, high:0, medium:1, low:1 }, endpointCount: 2,   aiInteractions: 85000,   groups: [{ name: "Data Science", count: 2 }],                                                                         deviceCount: 2, lastSeen: "2d ago",  skillCount: 4 },

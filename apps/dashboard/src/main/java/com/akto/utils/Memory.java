...
import static com.akto.utils.Build.*;
...
//        https://juiceshop.akto.io/rest/user/login
        ...
        memory.build(apiInfoKeys, new HashMap<>());
    ...
    public void build(List<ApiInfo.ApiInfoKey> apiInfoKeys, Map<Integer, ReplaceDetail> replaceDetailsMap) {
    ...
    public OriginalHttpRequest execute(List<SampleData> sdList) {
        int idx = 0;
        for (SampleData sampleData: sdList) {
            idx++;

  ...
  const conditionsCard = (
    <LegacyCard title={
      <VerticalStack gap={"1"}>
        ...
        <Text variant='bodyMd'>
          A custom data type will be created based on these key and value conditions
        </Text>
      </VerticalStack>
    } 
    key="condition">
  ...
  const requestCard = (
    <VerticalStack gap="5" key="sensitive">
      ...
      <div className='footer-save'>
        <Button id={"save-button"} onClick={saveAction} {...compareFunc() ? {disabled: true} : {}} primary> Save </Button>
      </div>
    </VerticalStack>
  )

...
public class ElasticSearchClient {
    ...
    /**
     * Scrolls Elasticsearch for agentic query records in [startTsMs, endTsMs) for the given accountId.
     * Invokes handler for each hit. Stops calling handler once maxRecords have been delivered.
     * Always releases the scroll cursor on exit.
     */
    ...
    private AgentQueryRecord parseHit(JSONObject hit) {
        ...
        if (queryPayload == null || queryPayload.isEmpty()) return null;

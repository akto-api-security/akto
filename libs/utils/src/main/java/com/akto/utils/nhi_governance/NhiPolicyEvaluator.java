...
public final class NhiPolicyEvaluator {
    ...
    public static void evaluate(NhiIdentity identity) {
        ...
        // Pin contextSource so AccountsContextDaoWithContextSource reads/writes land in the right shard.
            ...
            if (StringUtils.isNotBlank(identity.getContextSource())) {
                try {
                    Context.contextSource.set(
                            GlobalEnums.CONTEXT_SOURCE.valueOf(identity.getContextSource().toUpperCase()));

...
//                + "Your task is to determine if the provided API RESPONSE satisfies or violates the given CONTEXT criteria. "
//                + "You must validate only according to the CONTEXT — do not consider any unrelated vulnerabilities, threats, or patterns.\n\n"
//                + "RULES:\n"
//                + "1. Read the CONTEXT carefully. Identify the exact validation condition(s) it describes.\n"
//                + "2. Examine the RESPONSE strictly against those condition(s) only.\n"
//                + "3. If the RESPONSE violates the CONTEXT criteria, output:\n"
//                + "   {\"vulnerable\": false, \"reason\": \"<proof from the response which violates the criteria>\"}\n"
//                + "4. If the RESPONSE meets the CONTEXT criteria, output:\n"
//                + "   {\"vulnerable\": true, \"reason\": \"<proof from the response which violates the criteria>\"}\n"
//                + "5. Output must be a single valid JSON object exactly in the above format.\n"
//                + "6. Do not add extra text, formatting, or explanation outside the JSON.\n\n"
//                + "INPUTS:\n"
//                + "CONTEXT: \n"

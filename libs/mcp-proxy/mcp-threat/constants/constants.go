...
Output strictly in JSON (no prose). Use these fields:
{
  ...
  "confidence": 0.0-1.0,
  "categories": [
    "LLM01_PROMPT_INJECTION","LLM02_SENSITIVE_INFO_DISCLOSURE","LLM03_SUPPLY_CHAIN","LLM04_DATA_MODEL_POISONING",
	"LLM05_IMPROPER_OUTPUT_HANDLING","LLM06_EXCESSIVE_AGENCY","LLM07_SYSTEM_PROMPT_LEAKAGE",
	"LLM08_VECTOR_EMBEDDING_WEAKNESSES","LLM09_MISINFORMATION","LLM10_UNBOUNDED_CONSUMPTION",

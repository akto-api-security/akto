...
public class TrafficCollectorLogsDao extends AccountsContextDao<Log> {

    public static final int maxDocuments = 100_000;
    public static final int sizeInBytes = 100_000_000;

    public static final TrafficCollectorLogsDao instance = new TrafficCollectorLogsDao();

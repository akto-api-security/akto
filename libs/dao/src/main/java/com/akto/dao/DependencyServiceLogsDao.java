...
public class DependencyServiceLogsDao extends AccountsContextDao<Log> {

    public static final DependencyServiceLogsDao instance = new DependencyServiceLogsDao();
    ...
    public String getCollName() {
        return "logs_dependency_service";
    }

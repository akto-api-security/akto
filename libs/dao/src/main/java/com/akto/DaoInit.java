...
public class DaoInit {
    ...
    public static CodecRegistry createCodecRegistry(){
        ...
        ClassModel<EndpointShieldServer> endpointShieldServerClassModel = ClassModel.builder(EndpointShieldServer.class).enableDiscriminator(true).build();
        ...
        CodecRegistry pojoCodecRegistry = fromProviders(PojoCodecProvider.builder().register(
                ...
                ticketSyncJobParamsClassModel, apiHitCountInfoClassModel, collectionTagsModel, apiSequencesClassModel,endpointShieldServerClassModel, endpointShieldLogClassModel)
    ...
    public static void createIndices() {
        ...
        EndpointShieldServerDao.instance.createIndicesIfAbsent();

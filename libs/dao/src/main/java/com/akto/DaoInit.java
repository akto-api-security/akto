...
public class DaoInit {
    ...
    public static CodecRegistry createCodecRegistry(){
        ...
        ClassModel<MultiCollectionTestingEndpoints> multiCollectionTestingEndpointsClassModel = ClassModel
                .builder(MultiCollectionTestingEndpoints.class).enableDiscriminator(true).build();
        ...
        ClassModel<AccountConfig.AccountEntry> AccountEntryClassModel = ClassModel.builder(AccountConfig.AccountEntry.class).enableDiscriminator(true).build();
        ...
        ClassModel<JobParams> jobsParam = ClassModel.builder(JobParams.class).enableDiscriminator(true).build();
        ...
        CodecRegistry pojoCodecRegistry = fromProviders(PojoCodecProvider.builder().register(
                ...
                UsageMetricClassModel, UsageMetricInfoClassModel, UsageSyncClassModel, OrganizationClassModel, AccountConfigClassModel, AccountEntryClassModel,
    ...
    public static void createIndices() {
        ...
        RuntimePersistentLogsDao.instance.createIndicesIfAbsent();

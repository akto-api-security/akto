...
public class GlobalEnums {
    ...
    public enum TestCategory {
        BOLA("BOLA", Severity.HIGH, "Broken Object Level Authorization"),
        NO_AUTH("NO_AUTH", Severity.HIGH, "Broken User Authentication"),
        BFLA("BFLA", Severity.HIGH, "Broken Function Level Authorization"),
        IAM("IAM", Severity.HIGH, "Improper Assets Management");
        private final String name;

...
public class BackwardCompatibility {
    ...
    public static final String ADD_SOURCE_TO_STI_API_INFO = "addSourceToStiApiInfo";
    private int addSourceToStiApiInfo;
    ...
    public BackwardCompatibility(int id, int dropFilterSampleData, int resetSingleTypeInfoCount, int dropWorkflowTestResult,
                                 ...
                                 int addDefaultFilters, int moveAzureSamlToNormalSaml, int deleteOptionsAPIs, int addSourceToStiApiInfo) {
        this.id = id;
        ...
        this.addSourceToStiApiInfo = addSourceToStiApiInfo;
    }
    ...
    public int getAddSourceToStiApiInfo() {
        return addSourceToStiApiInfo;
    }

    public void setAddSourceToStiApiInfo(int addSourceToStiApiInfo) {
        this.addSourceToStiApiInfo = addSourceToStiApiInfo;
    }
}

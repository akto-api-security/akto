...
public class TestResult extends GenericTestResult {
    ...
    public enum TestError {
        ...
        API_REQUEST_FAILED_BEFORE_SENDING("API request failed before sending", false),
        API_CONNECTION_TIMEOUT("API connection timed out", false),
        API_HOST_UNREACHABLE("API host unreachable", false),
        API_CONNECTION_REFUSED("API connection refused", false),
        API_SSL_HANDSHAKE_FAILED("SSL/TLS handshake failed", false),
        API_RESPONSE_BODY_NULL("API response body is null", false),
        API_RESPONSE_PARSE_FAILED("Failed to parse API response", false),
        ...
        NO_REQUEST_ATTEMPTED("No test request attempted - test and original payloads are identical", false),

...
public class TestDependencyNode {
    ...
    public void testUpdateOrCreateParamInfo() {
        ...
        DependencyNode.ParamInfo paramInfo1 = new DependencyNode.ParamInfo("req2a", "resp1a", 2);
        ...
        DependencyNode.ParamInfo paramInfo2 = new DependencyNode.ParamInfo("req2b", "resp1b", 2);
